...
void TriMesh::readObj(const std::string& filename)
{
	...
	while (std::getline(fin, line))
	{
		...
		// 读取面片信息
			...
			// 每个面片由3个顶点构成
			// 格式为 f v1/vt1/vn1 v2/vt2/vn2 v3/vt3/vn3
			sin >> a0 >> slash >> a1 >> slash >> a2;
			sin >> b0 >> slash >> b1 >> slash >> b2;
			sin >> c0 >> slash >> c1 >> slash >> c2;
			
			// obj文件顶点索引从1开始，需要减1
			faces.push_back(vec3i(a0-1, b0-1, c0-1));
			texture_index.push_back(vec3i(a1-1, b1-1, c1-1));
			normal_index.push_back(vec3i(a2-1, b2-1, c2-1));
		}
	}
