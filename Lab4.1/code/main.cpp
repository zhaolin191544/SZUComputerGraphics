...
void init()
{
	...
	disk->setTranslation(glm::vec3(0.5, 0.0, 0.0));
	...
	// 生成圆锥并贴图
	cone->generateCone(100, 0.2, 0.3);
	cone->setTranslation(glm::vec3(0.0, -0.2, 0.0));
...
int main(int argc, char **argv)
{
	...
	// 配置窗口属性
	GLFWwindow* window = glfwCreateWindow(600, 600, "2022220036_赵麟_实验4.1", NULL, NULL);
	if (window == NULL)
	{
